...
{	
	 ...
	 $Curd_quantity = $_POST['Curd_quantity'];
     $price = $Curd_quantity * 28;
    ...
    mysqli_query($conn,"INSERT INTO curd (id,Customer_name,Curd_quantity,price)
    VALUES ('$id','$Customer_name','$Curd_quantity','$price')");
...
<div>
      ...
      <table>
		...
		<tr>
          <td>Milk_Quantity</td>
          <td><?php echo $Curd_quantity;?>L</td>
        </tr>
		</table>
      <hr />
    <table>

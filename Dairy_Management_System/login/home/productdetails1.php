...
{	
    ...
    mysqli_query($conn,"INSERT INTO milk (id,Customer_name,Milk_quantity,price)
    VALUES ('$id','$Customer_name','$Milk_quantity','$price')");
...
<div>
      ...
      <table>
		...
		<tr>
          <td>Milk_Quantity</td>
          <td><?php echo $Milk_quantity;?>L</td>
        </tr>
		</table>
      <hr />
    <table>

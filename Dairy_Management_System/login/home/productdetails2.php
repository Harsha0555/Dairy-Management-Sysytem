...
{	
	 ...
	 $Ghee_quantity = $_POST['Ghee_quantity'];
     $price = $Ghee_quantity * 300;
    ...
    mysqli_query($conn,"INSERT INTO ghee (id,Customer_name,Ghee_quantity,price)
    VALUES ('$id','$Customer_name','$Ghee_quantity','$price')");

...
{	
	 ...
	 $Cheese_quantity = $_POST['Cheese_quantity'];
     $price = $Cheese_quantity * 450;
    ...
    mysqli_query($conn,"INSERT INTO cheese (id,Customer_name,Cheese_quantity,price)
    VALUES ('$id','$Customer_name','$Cheese_quantity','$price')");
...
<div>
      ...
      <table>
		...
		<tr>
          <td>Cheese_Quantity</td>
          <td><?php echo $Cheese_quantity;?></td>
        </tr>
		</table>
      <hr />
    <table>
